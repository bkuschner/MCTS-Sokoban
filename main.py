...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_mcts_rollouts", type=int, help="Number of rollouts per move", default=100)
    parser.add_argument("--max_mcts_depth", type=int, help="Depth of each rollout", default=25)
